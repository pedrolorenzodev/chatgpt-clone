...
/**
 * OpenAI "flower/knot" logo rendered as SVG.
 * Path data sourced from the official OpenAI brand mark (viewBox 24x24).
 */
function OpenAILogo({
  size = Dimensions.openaiLogoSize,
  color = Colors.text.primary,
}: OpenAILogoProps): React.ReactElement {
  return (
    <View
      style={styles.container}
      accessibilityLabel="OpenAI logo"
